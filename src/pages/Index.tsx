...
const BANQUETS: Banquet[] = [
  ...
  const BANQUETS = [
  { id: "373", name: "Ratan Villas Resort", city: "Sariska National Park, Paitpur, near Alwar" },
  { id: "374", name: "MK Garden", city: "Kala Kuan Main Road, Housing Board, Vivekanad Nagar, Alwar" },
  { id: "375", name: "Alwar Bagh", city: "Village Dhawla, Alwar - Jaipur Road, Alwar" },
  { id: "376", name: "Tijara Fort Palace", city: "Tijara, Alwar" },
  { id: "377", name: "Siddhi Vinayak Marriage Garden", city: "Behror, Alwar" },
  { id: "378", name: "Shiva Oasis Resort", city: "Neemrana, Alwar" },
  { id: "379", name: "Ritumbhara Hotel and Resort", city: "Alwar City, Alwar" },
  { id: "380", name: "The Quila Camps & Resort", city: "Rajgarh Road, Burja, Alwar" },
  { id: "381", name: "Alwar Vanyaevilas", city: "Alwar City, Alwar" },
  { id: "382", name: "Royal Krishna Garden", city: "Alwar" },
  { id: "383", name: "Sunrise Resort", city: "Kati Ghati Road, Alwar" },
  { id: "384", name: "The Fern An Ecotel Hotel", city: "Sariska, Alwar" },
  { id: "385", name: "Gulmohar Sariska Resort", city: "Sariska, Alwar" },
  { id: "386", name: "Aapno Marriage Garden", city: "Alwar City, Alwar" },
  { id: "387", name: "Sariska Tiger Camp Resort", city: "Alwar City, Alwar" },
  { id: "388", name: "The Alwar Resort", city: "Alwar Road, Alwar" },
  { id: "389", name: "The Shehnai Resort", city: "Alwar" },
  { id: "390", name: "Fatehgarh Farm", city: "Moti Doongri, Alwar" },
  { id: "391", name: "Hill Fort - Kesroli", city: "Jyoti Nagar, Alwar" },
  { id: "392", name: "The Riwaz Resort", city: "Alwar City, Alwar" },
  { id: "393", name: "Royal Court Banquet Hall", city: "Neemrana, Alwar" },
  { id: "394", name: "Hotel R G Bilkha Hotel And Resorts", city: "Kati Ghati, Silisherh, Alwar - 301001" },
  { id: "395", name: "Royal Marriage Garden", city: "Raghu Marg, Alwar - 301001" },
  { id: "396", name: "Spree Resort Sariska", city: "Talvrx Road, Alwar Bypass, Thanagazi, Alwar - 301022" },
  { id: "397", name: "Haut Monde Rajputana Palace", city: "NH 48, Hamjapur, Behror" },
  { id: "398", name: "The Govindam Resort", city: "Vrindavan, Tahra" },
  { id: "399", name: "Hotel Vandana", city: "Alwar Rajgarh Road, Burja, Alwar - 301001" },
  { id: "400", name: "Hotel Tokas", city: "Neemrana, Alwar" },
  { id: "401", name: "Days Hotel By Wyndham Neemrana", city: "Neemrana, Alwar" },
  { id: "402", name: "Ramada by Wyndham", city: "Neemrana, Alwar" },
  { id: "403", name: "Payal Marriage Garden", city: "Jaipur Road Bhakhera, Alwar" },
  { id: "404", name: "Tanya Resort", city: "Alwar - Esarpur" },
  { id: "405", name: "Vivaana Culture Hotel", city: "Alwar" },
  { id: "406", name: "Gokul Kunj", city: "Neemrana, Alwar" },
  { id: "407", name: "Cambay Sapphire", city: "Neemrana, Alwar" },
  { id: "408", name: "Raj Mahal Restaurant", city: "Bhiwadi, Alwar" },
  { id: "409", name: "Hotel Centre Point", city: "Neemrana, Alwar" },
  { id: "410", name: "Hotel Inderlok Signature", city: "Neemrana, Alwar" },
  { id: "411", name: "Sarovar Premier Alwar", city: "Moti Doongri, Alwar" },
  { id: "412", name: "Aditya Palace", city: "Alwar City, Alwar" },
  { id: "413", name: "Hotel Matsya Aravali", city: "Alwar City, Alwar" },
  { id: "414", name: "Bond Well Hotel", city: "Aerodrome Road, Daudpur, Alwar" },
  { id: "415", name: "Hotel Green Orch", city: "Main Jaipur Road, Alwar" },
  { id: "416", name: "Sufiyana Banquet And Conference Hall", city: "Neemrana, Alwar" },
  { id: "417", name: "Hotel Nirvana Palace", city: "Pratap Baas, Alwar" },
  { id: "418", name: "The Lal Vilas Hotels & Resorts", city: "Delhi Jaipur Highway, Neemrana, Alwar" },
  { id: "419", name: "Hotel Grand Ashoka", city: "Rajgarh - Alwar Road, Alwar" },
  { id: "420", name: "Lemon Tree Hotel Alwar", city: "Malviya Nagar, Alwar" },
  { id: "421", name: "Lemonade Hotel", city: "Moti Doongri, Alwar" },
  { id: "422", name: "Alwar Motel and Resorts", city: "Narnaul - Behror - Alwar" },
  { id: "423", name: "Cygnett Lite Alwar", city: "Near samola circle, alwar" },
  { id: "424", name: "Red Fox by Lemon Tree Hotels", city: "A Block, Malviya Nagar" },
  { id: "425", name: "Hotel Alwar Royals", city: "Near, Nagli Cir, Alwar" },
  { id: "426", name: "Hotel Wings Grand", city: "near Kanyaiya Sweet," },
  { id: "427", name: "Hotel Hallmark Alwar", city: "near radhika kunj dhiapaidi, Alwar," },
  { id: "428", name: "Pavna Palace Hotel", city: "Shanti Kunj, Malviya Nagar, Alwar," },
  { id: "429", name: "Aditya Palace", city: "Matsya Industrial Area, Alwar" }
];

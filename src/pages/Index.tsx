...
const BANQUETS: Banquet[] = [
  ...
  { id: "373", name: "Ratan Villas Resort", city: "Sariska National Park, Paitpur, near Alwar", capacity: 450, basePrice: 2300 },
  { id: "374", name: "MK Garden", city: "Kala Kuan Main Road, Housing Board, Vivekanad Nagar, Alwar", capacity: 700, basePrice: 1500 },
  { id: "375", name: "Alwar Bagh", city: "Village Dhawla, Alwar - Jaipur Road, Alwar", capacity: 300, basePrice: 3200 },
  { id: "376", name: "Tijara Fort Palace", city: "Tijara, Alwar", capacity: 600, basePrice: 4800 },
  { id: "377", name: "Siddhi Vinayak Marriage Garden", city: "Behror, Alwar", capacity: 850, basePrice: 1100 },
  { id: "378", name: "Shiva Oasis Resort", city: "Neemrana, Alwar", capacity: 500, basePrice: 2700 },
  { id: "379", name: "Ritumbhara Hotel and Resort", city: "Alwar City, Alwar", capacity: 250, basePrice: 3900 },
  { id: "380", name: "The Quila Camps & Resort", city: "Rajgarh Road, Burja, Alwar", capacity: 900, basePrice: 1800 },
  { id: "381", name: "Alwar Vanyaevilas", city: "Alwar City, Alwar", capacity: 400, basePrice: 4100 },
  { id: "382", name: "Royal Krishna Garden", city: "Alwar", capacity: 750, basePrice: 1300 },
  { id: "383", name: "Sunrise Resort", city: "Kati Ghati Road, Alwar", capacity: 550, basePrice: 3000 },
  { id: "384", name: "The Fern An Ecotel Hotel", city: "Sariska, Alwar", capacity: 350, basePrice: 4500 },
  { id: "385", name: "Gulmohar Sariska Resort", city: "Sariska, Alwar", capacity: 800, basePrice: 1000 },
  { id: "386", name: "Aapno Marriage Garden", city: "Alwar City, Alwar", capacity: 650, basePrice: 2500 },
  { id: "387", name: "Sariska Tiger Camp Resort", city: "Alwar City, Alwar", capacity: 200, basePrice: 3700 },
  { id: "388", name: "The Alwar Resort", city: "Alwar Road, Alwar", capacity: 950, basePrice: 1600 },
  { id: "389", name: "The Shehnai Resort", city: "Alwar", capacity: 400, basePrice: 4000 },
  { id: "390", name: "Fatehgarh Farm", city: "Moti Doongri, Alwar", capacity: 700, basePrice: 1200 },
  { id: "391", name: "Hill Fort - Kesroli", city: "Jyoti Nagar, Alwar", capacity: 500, basePrice: 2800 },
  { id: "392", name: "The Riwaz Resort", city: "Alwar City, Alwar", capacity: 300, basePrice: 4300 },
  { id: "393", name: "Royal Court Banquet Hall", city: "Neemrana, Alwar", capacity: 850, basePrice: 1900 },
  { id: "394", name: "Hotel R G Bilkha Hotel And Resorts", city: "Kati Ghati, Silisherh, Alwar - 301001", capacity: 450, basePrice: 3500 },
  { id: "395", name: "Royal Marriage Garden", city: "Raghu Marg, Alwar - 301001", capacity: 750, basePrice: 1400 },
  { id: "396", name: "Spree Resort Sariska", city: "Talvrx Road, Alwar Bypass, Thanagazi, Alwar - 301022", capacity: 550, basePrice: 2900 },
  { id: "397", name: "Haut Monde Rajputana Palace", city: "NH 48, Hamjapur, Behror", capacity: 350, basePrice: 4700 },
  { id: "398", name: "The Govindam Resort", city: "Vrindavan, Tahra", capacity: 900, basePrice: 1700 },
  { id: "399", name: "Hotel Vandana", city: "Alwar Rajgarh Road, Burja, Alwar - 301001", capacity: 400, basePrice: 3800 },
  { id: "400", name: "Hotel Tokas", city: "Neemrana, Alwar", capacity: 650, basePrice: 1100 },
  { id: "401", name: "Days Hotel By Wyndham Neemrana", city: "Neemrana, Alwar", capacity: 250, basePrice: 2600 },
  { id: "402", name: "Ramada by Wyndham", city: "Neemrana, Alwar", capacity: 800, basePrice: 4200 },
  { id: "403", name: "Payal Marriage Garden", city: "Jaipur Road Bhakhera, Alwar", capacity: 500, basePrice: 1500 },
  { id: "404", name: "Tanya Resort", city: "Alwar - Esarpur", capacity: 300, basePrice: 3100 },
  { id: "405", name: "Vivaana Culture Hotel", city: "Alwar", capacity: 950, basePrice: 4900 },
  { id: "406", name: "Gokul Kunj", city: "Neemrana, Alwar", capacity: 450, basePrice: 1000 },
  { id: "407", name: "Cambay Sapphire", city: "Neemrana, Alwar", capacity: 700, basePrice: 2400 },
  { id: "408", name: "Raj Mahal Restaurant", city: "Bhiwadi, Alwar", capacity: 500, basePrice: 3600 },
  { id: "409", name: "Hotel Centre Point", city: "Neemrana, Alwar", capacity: 200, basePrice: 4600 },
  { id: "410", name: "Hotel Inderlok Signature", city: "Neemrana, Alwar", capacity: 850, basePrice: 1300 },
  { id: "411", name: "Sarovar Premier Alwar", city: "Moti Doongri, Alwar", capacity: 400, basePrice: 2800 },
  { id: "412", name: "Aditya Palace", city: "Alwar City, Alwar", capacity: 750, basePrice: 3900 },
  { id: "413", name: "Hotel Matsya Aravali", city: "Alwar City, Alwar", capacity: 550, basePrice: 1800 },
  { id: "414", name: "Bond Well Hotel", city: "Aerodrome Road, Daudpur, Alwar", capacity: 350, basePrice: 4100 },
  { id: "415", name: "Hotel Green Orch", city: "Main Jaipur Road, Alwar", capacity: 900, basePrice: 1200 },
  { id: "416", name: "Sufiyana Banquet And Conference Hall", city: "Neemrana, Alwar", capacity: 450, basePrice: 2700 },
  { id: "417", name: "Hotel Nirvana Palace", city: "Pratap Baas, Alwar", capacity: 700, basePrice: 3400 },
  { id: "418", name: "The Lal Vilas Hotels & Resorts", city: "Delhi Jaipur Highway, Neemrana, Alwar", capacity: 500, basePrice: 4400 },
  { id: "419", name: "Hotel Grand Ashoka", city: "Rajgarh - Alwar Road, Alwar", capacity: 250, basePrice: 1600 },
  { id: "420", name: "Lemon Tree Hotel Alwar", city: "Malviya Nagar, Alwar", capacity: 800, basePrice: 2900 },
  { id: "421", name: "Lemonade Hotel", city: "Moti Doongri, Alwar", capacity: 300, basePrice: 3700 },
  { id: "422", name: "Alwar Motel and Resorts", city: "Narnaul - Behror - Alwar", capacity: 950, basePrice: 1000 },
  { id: "423", name: "Cygnett Lite Alwar", city: "Near samola circle, alwar", capacity: 400, basePrice: 2300 },
  { id: "424", name: "Red Fox by Lemon Tree Hotels", city: "A Block, Malviya Nagar", capacity: 750, basePrice: 3200 },
  { id: "425", name: "Hotel Alwar Royals", city: "Near, Nagli Cir, Alwar", capacity: 550, basePrice: 4800 },

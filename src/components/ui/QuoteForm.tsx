...
ISRA licenses & Special Venue charges Will be Extra as per Government Policy.
...
Makeup Artist and Photographer - Food, Stay and Travel Expenses provided by Client.
Management fee will be applicable over and above the package. 
The same will be discussed and finalized during the meeting.`,
    discountAmount: 0,
    brandType: 'shaadi'
  });
